...
export const Sidebar: React.FC = () => {
  ...
  const selectedRiverIds = selectedHes
    ? (selectedHes.details?.riverIds as unknown[] ?? []).map(String)
    : selectedRiver ? [selectedRiver.id] : [];
  const selectedFlowDirectionVerified = selectedRiverIds.some((riverId) => {
