...
export function ensureHydrologyOverlay(map: MapLibreMap, collections: OverlayCollections, options: OverlayOptions, onImagesReady?: () => void): boolean {
  ...
  addLayer(map, { id: 'rivers-flow-particles-glow', type: 'circle', source: 'rivers-flow-particles', minzoom: 4, paint: { 'circle-radius': ['interpolate', ['linear'], ['zoom'], 4, ['case', ['get', 'selected'], 5, 3.4], 8, ['case', ['get', 'selected'], 8, 5.8], 12, ['case', ['get', 'selected'], 10, 7]], 'circle-color': '#22d3ee', 'circle-opacity': ['*', ['coalesce', ['get', 'opacity'], 0.8], 0.34], 'circle-blur': 0.78 } });
  addLayer(map, { id: 'rivers-flow-particles', type: 'circle', source: 'rivers-flow-particles', minzoom: 4, paint: { 'circle-radius': ['interpolate', ['linear'], ['zoom'], 4, ['case', ['get', 'selected'], 2.2, 1.4], 8, ['case', ['get', 'selected'], 4.2, 2.7], 12, ['case', ['get', 'selected'], 5.4, 3.6]], 'circle-color': '#f8fafc', 'circle-opacity': ['coalesce', ['get', 'opacity'], 0.9], 'circle-blur': 0.12, 'circle-stroke-width': ['case', ['get', 'selected'], 2, 1], 'circle-stroke-color': '#22d3ee', 'circle-stroke-opacity': ['coalesce', ['get', 'opacity'], 0.9] } });
